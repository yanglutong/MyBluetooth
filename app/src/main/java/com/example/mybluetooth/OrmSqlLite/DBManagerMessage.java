...
public class DBManagerMessage {
    private static DBManagerMessage dbManager;

    static {
        try {
            dbManager = new DBManagerMessage(App.getContext());
    ...
    public DBManagerMessage(Context context) throws SQLException {
        ...
        dao = ormHelper.getDao(MessageModel.class);
    }
     ...
     * @thro
     */
    public void insertdemoBean(MessageModel demoBean) throws SQLException {
     ...
     * @throws SQLException
     */
    public void batchInsert(List<MessageModel> demoBean) throws SQLException {
        dao.create(demoBean);
    }
     ...
     * @throws SQLException
     */
    public List<MessageModel> getdemoBeanList() throws SQLException {
        List<MessageModel> list = dao.queryForAll();
        return list;
    }
     ...
     * @throws SQLException
     */
    public List<MessageModel> querySelect(String key, String value) throws SQLException {
        //Eq是equals的缩写
        //方法1
...
//        queryBuilder.orderBy("age",true);
        ...
        List<MessageModel> query = queryBuilder.query();//此方法相当于build，提交设置
        return query;
    }
     ...
     * @throws SQLException
     */
    public void deletedemoBean(MessageModel demoBean) throws SQLException {
        //只看id
        dao.delete(demoBean);
    }
     ...
     * @throws SQLException
     */
    public void updateName(MessageModel demoBean, String name) throws SQLException {
